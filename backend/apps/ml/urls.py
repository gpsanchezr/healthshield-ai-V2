...
from .views import ModeloMetricasView, ModeloHistorialView, PredecirPacienteView, EntrenarModeloView, PrediccionListView, AnalisisIAView, ProveedoresIAView, ConfusionMatrixView
